...
function Library.CreateWindow(config)
    ...
    SidebarFixTop.Size = UDim2.new(1, 0, 0, 12)
    ...
    SidebarFixRight.Size = UDim2.new(0, 12, 1, 0)
    SidebarFixRight.Position = UDim2.new(1, -12, 0, 0)
    ...
    local function BuildDropdown(page, tabName, order, opts)
        ...
        Box.Parent = Card
        Round(Box, 6)
        Bind(Box, "BackgroundColor3", function() return Theme.Tile end)
        ...
        local function buildOptions()
            ...
            for i, opt in ipairs(options) do
                ...
                OptBtn.MouseEnter:Connect(function()
                    Tween(OptBtn, 0.1, { BackgroundTransparency = 0, BackgroundColor3 = Theme.CardHover })
                end)
        ...
        Box.MouseEnter:Connect(function() Tween(Box, 0.15, { BackgroundColor3 = Theme.CardHover }) end)
        Box.MouseLeave:Connect(function() Tween(Box, 0.15, { BackgroundColor3 = Theme.Tile }) end)
